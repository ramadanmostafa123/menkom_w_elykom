...
class RegisterFormAsRecyclingCompany extends StatefulWidget {
  const RegisterFormAsRecyclingCompany({super.key});

  @override
  State<RegisterFormAsRecyclingCompany> createState() =>
      _RegisterFormAsRecyclingCompanyState();
}

class _RegisterFormAsRecyclingCompanyState
    extends State<RegisterFormAsRecyclingCompany> {
